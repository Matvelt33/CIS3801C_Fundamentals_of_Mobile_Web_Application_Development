                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="mainNav">
						<ul class="navbar-nav nav-justified w-100">
							...
							<li class="nav-item active"><a class="nav-link" href="livemusic.php">Live Music <span class="sr-only">(current)</span></a></li>
			...
			<div class="container main-content">
				<div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <p>We currently have no live music scheduled. Check back later for more information.</p>
