                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="mainNav">
						<ul class="navbar-nav nav-justified w-100">
							...
							<li class="nav-item active"><a class="nav-link" href="employees.php">Employees <span class="sr-only">(current)</span></a></li>
				...
				<div class="row">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT firstName, lastName, email, Position FROM employees";
